...
dummies_renewable <- seasonaldummy(ts_renewable_detrend)

seas_means_model_renewable <- lm(ts_renewable_detrend ~ dummies_renewable)
...
dummies_hydro <- seasonaldummy(ts_hydro_detrend)

seas_means_model_hydro <- lm(ts_hydro_detrend ~ dummies_hydro)
