...
autoplot(renewable_ts[,1], series = "Original") +
  autolayer(ts_renewable_detrend[,1],series="Detrended") +
...
print(cor(yearly_ts, my_year, method="spearman"))
