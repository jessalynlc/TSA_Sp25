...
SARIMA allows you to model the seasonal component so you don't have to get rid of seasonality from the data to run the model like you would do with ARIMA.
