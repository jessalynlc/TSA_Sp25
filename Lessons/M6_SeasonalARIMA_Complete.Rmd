...
Our SARIMA example from class had -164 while the non-seasonal model had -198, does that mean ARIMA giving better results than SARIMA?

Because of non seasonal ARIMA, we are looking at AIC, comparing fitted values with no seasonal component, so we are not comparing the same thing
