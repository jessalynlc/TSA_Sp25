...
Decompose use moving average method.
...
#random is original data - season - trend.
#Look at trend comp that it also starts with NA
#Talking about moving average, whenever we use this to calculate trend component, if we do centered moving average, we'll lose first few observations and last few observations. You can only find trend component after 6 months! 
...
#6 in the beginning, 6 at the end
